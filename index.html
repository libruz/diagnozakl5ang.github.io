...
<body>
    ...
    <script>
        ...
        function playAudio(audioFile, taskId) {
            ...
            // W rzeczywistej aplikacji tutaj odtwarzalibyśmy plik audio
            // W przykładzie symulujemy odtwarzanie
            showMessage(`Odtwarzanie nagrania ${audioFile}... (${audioPlayCounts[taskId]}/${task.audioPlays})`, "success");
